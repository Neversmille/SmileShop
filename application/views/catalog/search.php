		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				...
				<div>
					...
					<form role="form" id="page-search" method="POST" action="/catalog/find">
						<div class="input-group search-page-wrap">
							<input type="text" class="form-control search-page-input" name="search" placeholder="Поиск по сайту...">
							<span class="input-group-btn search-page-button">
